...
for jj = 1:length(experiments_to_run)
    ...
    % Initialize variable to store raw k-space data that we can re-use if
    % reconstructing echoes separately and/or differently. Caching this data 
    ...
    for echo_index = 1:Num_echoes2process
        ...
        % For processing echoes separately
        ...
        % Perform b0 eddy current correction (only if not examining psf or if 
        % not using gradient calibration data)
